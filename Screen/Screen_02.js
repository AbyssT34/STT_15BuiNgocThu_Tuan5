...
export default function Screen_02({ navigation }) {
    ...
    useEffect(() => {
        if (ima == require("../assets/vs_blue.jpg")) setColor("Xanh");
        else if (ima == require("../assets/vs_red.jpg")) setColor("Đỏ");
        else if (ima == require("../assets/vs_black.jpg")) setColor("Đen");
        else if (ima == require("../assets/vs_silver.jpg")) setColor("Bạc");
    }, [ima]); // hàm sẽ chạy khi có thay đổi về giá trị ở ima
    return (
        <View style={styles.container}>
            <View style={styles.top}>
                <ImageBackground source={ima} style={{ width: "100px", height: "120px" }}></ImageBackground>
            ...
            <View style={styles.bottom}>
                <Text style={{ position: "relative", right: "70px", fontSize: "19px", fontWeight: "600" }}>
                    Chọn một màu bên dưới:
                </Text>

                <TouchableOpacity
                    style={{ backgroundColor: "#C5F1FB", width: "85px", height: "80px" }}
                    onPress={() => {
                ...
                <TouchableOpacity
                    style={{ backgroundColor: "#F30D0D", width: "85px", height: "80px" }}
                    onPress={() => {
                ...
                <TouchableOpacity
                    style={{ backgroundColor: "#000000", width: "85px", height: "80px" }}
                    onPress={() => {
                ...
                <TouchableOpacity
                    style={{ backgroundColor: "#234896", width: "85px", height: "80px" }}
                    onPress={() => {
